...
public class WomenSocksActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        DatabaseReference socksRefe = FirebaseDatabase.getInstance().getReference().child("socks").child("women");

        FirebaseRecyclerOptions<products> socksoptions = new
                FirebaseRecyclerOptions.Builder<products>()
                .setQuery(socksRefe, products.class)//the category shows what you want to show in the recycler view here we are searching using the pname
